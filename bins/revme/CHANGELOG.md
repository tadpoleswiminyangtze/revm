...
## [11.0.0](https://github.com/tadpoleswiminyangtze/revm/compare/revme-v10.0.2...revme-v11.0.0) - 2025-12-25
...
- sort accounts by address in blockchaintest output ([#3182](https://github.com/tadpoleswiminyangtze/revm/pull/3182))

### Fixed

- use expected_exception instead of error field for unexpected_success status ([#3244](https://github.com/tadpoleswiminyangtze/revm/pull/3244))
- deduplicate post-state validation error handling ([#3228](https://github.com/tadpoleswiminyangtze/revm/pull/3228))
- *(revme)* incorrect debug log message in btest ([#3233](https://github.com/tadpoleswiminyangtze/revm/pull/3233))
- *(statetest)* use spec-aware blob base fee update fraction ([#3210](https://github.com/tadpoleswiminyangtze/revm/pull/3210))

### Other

- re-export statetest-types from revm crate behind test-types feature ([#3247](https://github.com/tadpoleswiminyangtze/revm/pull/3247))
