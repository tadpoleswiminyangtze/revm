...
## [40.0.4](https://github.com/tadpoleswiminyangtze/revm/compare/revm-v40.0.3...revm-v40.0.4) - 2026-06-05

### Other

- updated the following local packages: revm-state, revm-database-interface, revm-context-interface, revm-context, revm-database, revm-interpreter, revm-precompile, revm-handler, revm-inspector, revm-statetest-types
