...
## [16.0.0](https://github.com/tadpoleswiminyangtze/revm/compare/revm-interpreter-v15.0.0...revm-interpreter-v16.0.0) - 2025-01-10
...
- implement serde for interpreter ([#1909](https://github.com/tadpoleswiminyangtze/revm/pull/1909))
...
- Add EOF Layout Fuzz Loop to `revme bytecode` ([#1677](https://github.com/tadpoleswiminyangtze/revm/pull/1677))
...
- Add the modifies_memory macro ([#1270](https://github.com/tadpoleswiminyangtze/revm/pull/1270))
...
- adding more test for i256 ([#1090](https://github.com/tadpoleswiminyangtze/revm/pull/1090))
...
- spell check (#615)
- make calc public  ([#575](https://github.com/tadpoleswiminyangtze/revm/pull/575))
...
- Fix panic! message ([#431](https://github.com/tadpoleswiminyangtze/revm/pull/431))
...
- Wrap all calls to interpreter.gas.erase_cost with checks if USE_GAS is enabled ([#346](https://github.com/tadpoleswiminyangtze/revm/pull/346))
...
- enable proptest with arbitrary feature ([#323](https://github.com/tadpoleswiminyangtze/revm/pull/323))
- typos (#232)
